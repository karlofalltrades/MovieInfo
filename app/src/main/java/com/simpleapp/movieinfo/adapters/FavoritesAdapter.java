...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.MovieViewHolder> {
    ...
    public FavoritesAdapter(List<Movie> movieList) {
    ...
    public int getItemCount() {
        return !movieList.isEmpty() && movieList != null ? movieList.size() : 0;
    }
    ...
    public static class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        public MovieViewHolder(@NonNull View itemView, SearchAdapter.OnItemClickListener onItemClickListener, List<Movie> movies) {
            super(itemView);
